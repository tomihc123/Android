...
public class ListAdapterSettings extends RecyclerView.Adapter<ListAdapterSettings.ViewHolder> {

    private List<Novela> novelas = new ArrayList<>();
    private final OnItemClickListener listener;
    private final Context context;

    public ListAdapterSettings(OnItemClickListener onItemClickListener, Context context) {
        this.listener = onItemClickListener;
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.fila_settings, parent, false);
        return new ViewHolder(itemView);
    }
