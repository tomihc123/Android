...
public class FragmentoAnadir extends Fragment {
    ...
    private Button confirmarNovela;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_fragmento_anadir, container, false);
        nuevoNombre = view.findViewById(R.id.nuevoNombreNovela);
        nuevaDescripcion = view.findViewById(R.id.nuevoDescripcionNovela);
        confirmarNovela = view.findViewById(R.id.botonAnadirConfirmar);

        confirmarNovela.setOnClickListener(new View.OnClickListener() {
            @Override
